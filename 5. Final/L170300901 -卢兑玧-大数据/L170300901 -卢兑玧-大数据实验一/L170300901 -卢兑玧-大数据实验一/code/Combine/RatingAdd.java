...
public class RatingAdd {
	...
	public static void main(String[] args)  throws IOException, ClassNotFoundException, InterruptedException {
      ...
      System.setProperty("HADOOP_USER_NAME", "root");
		...
		FileInputFormat.addInputPath(job, new Path("hdfs://master:9000/exp1/D_Combine/Step2/part-r-00000"));
		FileOutputFormat.setOutputPath(job, new Path("hdfs://master:9000/exp1/D_Combine/Step3"));
